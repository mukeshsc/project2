...
export class CommonServiceService {
  ...
  companyDeleteCalendarEvent(formData){
      ...
      'Authorization': this.token
		...
		return this.http.post(`${environment.apiBaseUrl}${environment.apiPath}companyDeleteCalendarEvent `,formData, {headers}).pipe(map(res => <any>res));
  }
...
showDocType(){
 ...
 testEmail(formData){
  ...
  compensationTemplate(){
    ...
    return this.http.get(`${environment.apiBaseUrl}${environment.apiPath}showCompensationTemplate`, {headers}).pipe(map(res => <any>res));
    }
  // edit compansation
