...
export class ViewSurveyComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    for(let item of question){
      item.survey_ColumnArray = item.survey_ColumnArray;
      item.survey_OptionArray = item.survey_OptionArray;
      item.survey_RowArray = item.survey_RowArray;
      item.survey_SliderOption = item.survey_SliderOption;
      item.survey_SubQuestion = item.survey_SubQuestion
    }
